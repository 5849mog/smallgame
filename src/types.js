...
export const ZOMBIE_TYPES = {
  ...
  normal: {
    ...
    speedMul: 1, scaleBase: 0.9, contactLoss: 0.004, maxRender: MAX_ZOMBIE_RENDER,
    unlockAt: 0,
  },
  // 恶魔猎手：技能"突进"——周期性猛冲
  hunter: {
    ...
    speedMul: 1.15, scaleBase: 0.95, contactLoss: 0.004, maxRender: 150,
    unlockAt: 150,
  },
  // 憎恶屠夫：血牛肉盾，撞上一次啃掉 1.2% 兵力
  butcher: {
    label: '憎恶屠夫',
    palette: { legs: 0x2c3038, torso: 0x4a525e, head: 0x9aa4b0, arms: 0x6a7480 },
    hp: (d) => 8 + Math.floor(d * 4.5),
    speedMul: 0.62, scaleBase: 1.5, contactLoss: 0.012, maxRender: 80,
    unlockAt: 250,
  },
  ...
  shadow: {
    ...
    speedMul: 1.3, scaleBase: 0.85, contactLoss: 0.004, maxRender: 120,
    unlockAt: 350,
  },
  ...
  witch: {
    ...
    speedMul: 0.85, scaleBase: 0.95, contactLoss: 0.004, maxRender: 60,
    unlockAt: 500,
  },
  ...
  banshee: {
    ...
    speedMul: 0.95, scaleBase: 1.0, contactLoss: 0.004, maxRender: 60,
    unlockAt: 650,
  },
  ...
  infected: {
    ...
    speedMul: 0.9, scaleBase: 0.95, contactLoss: 0.004, maxRender: 80,
    unlockAt: 450,
  },
};
